...
public class NetTest{
    ...
    public void URLTest() {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/nettest/index.html?username=tom");
        ...
        System.out.println(url.getPath());//    /nettest/index.html
        System.out.println(url.getFile());//    /nettest/index.html?username=tom
