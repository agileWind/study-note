...
#### 9.5.5 EL表达式在jsp页面无法解析的问题

1. 第一种方式：`<%@ page isELIgnored="true|false" %>`，当isELIgnored 值为true的时候，那么EL表达式将会被当做字符串进行解析

2. 第二种方式：Web.xml头部配置版本太低或者不全，例如使用web-app_3.0.dtd以上版本
